...
public class Bot implements Runnable {
	...
	private void GetColor() {
    	...
    	switch(n){
     	case 0:
     		client.sendColor(255, 0, 0);
    	case 1:
    		client.sendColor(0 ,255 ,0);
    	case 2:
    		client.sendColor(0 ,0 ,255);
    	case 3:
    		client.sendColor(125 , 125 ,125);
    	}
